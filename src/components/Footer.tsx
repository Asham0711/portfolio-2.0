          ...
          <div className=" flex flex-col items-center justify-center">
            <div className="flex space-x-4">
              <a href="https://github.com/Asham0711" target="_blank">
                <FaGithub size={24} className="text-black hover:scale-125 duration-200 cursor-pointer"/>
              </a>
              <a href="https://x.com/asham0711" target="_blank">
                <FaXTwitter size={24} className="text-black hover:scale-125 duration-200 cursor-pointer"/>
              </a>
              <a href="https://www.instagram.com/__ash._______?utm_source=qr&igsh=bm81ejQwbHR2cXdv" target="_blank">
                <FaInstagram size={24} className="text-black hover:scale-125 duration-200 cursor-pointer"/>
              </a>
              <a href="https://www.linkedin.com/in/md-asham-imad-926316224/" target="_blank">
                <FaLinkedinIn size={24} className="text-black hover:scale-125 duration-200 cursor-pointer"/>
              </a>
            </div>
