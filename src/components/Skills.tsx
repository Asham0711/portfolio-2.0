            ...
            <div>
                ...
                {lang &&(
                    <ul className='pt-10'>
                        ...
                        <li>
                            <div className='flex justify-between px-4 font-bold'>
                                <GrMysql className='text-[#e77bfa] text-3xl font-extrabold rounded-md' />
                                SQL
                            </div>
                            <br />
                            <div className='border-2 rounded-sm border-[#e77bfa] border-solid w-full'></div>
            ...
            <div>
                ...
                {frame && (
                    <ul className='pt-10'>
                        ...
                        <li>
                            <div className='flex justify-between px-4 font-bold'>
                                <TbBrandNextjs className='text-[#e77bfa] text-3xl font-extrabold rounded-md' />
                                Next Js
                            </div>
                            <br />
                            <div className='border-2 rounded-sm border-[#e77bfa] border-solid w-full'></div>
            ...
            <div>
                ...
                {tool && (
                    <ul className='pt-10'>
                        ...
                        <li>
                            <div className='flex justify-between px-4 font-bold'>
                                <VscVscode className='text-[#e77bfa] text-3xl font-extrabold' />
                                Visual Studio Code
                            </div>
                            <br />
                            <div className='border-2 rounded-sm border-[#e77bfa] border-solid w-full'></div>
