      ...
      <div className="flex flex-col gap-8 md:flex-row justify-between space-x-5 md:px-20">
        <div className="md:w-1/2 w-full px-20">
          <BackgroundGradient className="rounded-3xl">
            <Image src={pic} alt="Profile" className="rounded-3xl" />
          </BackgroundGradient>
        </div>
        <div className="md:w-1/2 flex flex-col justify-center gap-5 items-center">
          <p className="md:text-xl">
            Hello! I am Md Asham Imad, a passionate software engineer with a
            strong foundation in Information Technology. My expertise lies in
            the MERN stack (MongoDB, Express.js, React.js, Node.js) and NextJs,
            and I thrive on creating dynamic, responsive, and user-friendly web
            applications. With a keen eye for detail and a commitment to staying
            updated with the latest industry trends, I continuously strive to
            deliver efficient and innovative solutions. Welcome to my portfolio,
            where you can explore my journey and the projects I have worked on.
          </p>
          <button
